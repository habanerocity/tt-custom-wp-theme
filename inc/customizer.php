...
function wpdevs_customizer( $wp_customize ){
    ...
    $wp_customize->add_section(
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'description' => __('Type your copyright here', 'wp-devs' ),
    ...
    $wp_customize->add_section(
        ...
        $wp_customize->add_setting(
            ...
            array(
                'type' => 'theme_mod',
                'default' => __('Add hero title here', 'wp-devs' ),
                'sanitize_callback' => 'sanitize_text_field'
            )
            );
        ...
        $wp_customize->add_control(
            ...
            array(
                'label' => 'Hero Title',
                'description' => __('Add hero title here', 'wp-devs' ),
                'section' => 'sec_hero',
                'type' => 'text'
            )
            );
        ...
        $wp_customize->add_setting(
            ...
            array(
                'type' => 'theme_mod',
                'default' => __('Add hero subtitle here', 'wp-devs' ),
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'description' => __('Add hero subtitle here', 'wp-devs' ),
                'section' => 'sec_hero',
                'type' => 'textarea'
            )
            );
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'description' => __('Add hero button text here', 'wp-devs' ),
                'section' => 'sec_hero',
                'type' => 'text'
            )
            );
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'description' => __('Add hero button link here', 'wp-devs' ),
                'section' => 'sec_hero',
                'type' => 'url'
            )
            );
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'description' => __('Add hero height here', 'wp-devs' ),
                'section' => 'sec_hero',
                'type' => 'number'
            )
            );
